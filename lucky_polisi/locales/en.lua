Locales['en'] = {
  ...
  -- Ammo
  ['open_ammobox'] = 'press ~INPUT_CONTEXT~ to refill ammo',
  -- Armory
  ...
  -- Action Menu
  ['citizen_interaction'] = 'Menindak Warga',
  ['vehicle_interaction'] = 'Menindak Kendaraan',
  ['object_spawner'] = 'Mengeluarkan Barang',
  ['id_card'] = 'ID Card',
  ['search'] = 'Menggeledah',
  ['handcuffs'] = 'Memborgol',
  ['handcuff'] = 'Memborgol',
  ['unhandcuff'] = 'Membuka Borgol',
  ['drag'] = 'Menggiring',
  ['put_in_vehicle'] = 'Memasukkan ke Kendaraan',
  ['out_the_vehicle'] = 'Mengeluarkan dari Kendaraan',
  ['fine'] = 'Tilang',
  ['unpaid_bills'] = 'Periksa Tilang',
  ['license_check'] = 'Mengecek Lisensi',
  ...
  ['being_searched'] = 'kamu di geledah oleh Polisi',
  -- Vehicle interaction
  ...
  ['search_database'] = 'Identifikasi kendaraan',
